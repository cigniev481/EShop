...
namespace EShop.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ImageUrl,Price,Description,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ImageUrl,Price,Description,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
